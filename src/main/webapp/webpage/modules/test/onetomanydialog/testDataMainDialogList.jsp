                    ...
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="testDataMainDialog"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                ...
                                <sys:userselect id="tuser" name="tuser.id" value="${testDataMainDialog.tuser.id}"
                                                labelName="tuser.name" labelValue="${testDataMainDialog.tuser.name}"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                ...
                                <div class="col-xs-12">
                                    <form:radiobuttons class="i-checks" path="sex" items="${fns:getDictList('sex')}"
            ...
            <div id="toolbar">
                ...
                <shiro:hasPermission name="test:onetomanydialog:testDataMainDialog:import">
                    ...
                    <div id="importBox" class="hide">
                        <form id="importForm" action="${ctx}/test/onetomanydialog/testDataMainDialog/import"
