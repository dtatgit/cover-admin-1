...
<head>
    ...
    <%@include file="exceptionReportList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">异常上报列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="exceptionReport"
                                   class="form form-horizontal well clearfix">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="所在地区：">所在地区：</label>
                                <form:input path="address" htmlEscape="false" maxlength="64" class=" form-control"/>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="上报人：">上报人：</label>
                                <form:input path="createByName" htmlEscape="false" maxlength="64"
                                            class=" form-control"/>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="报警时间：">&nbsp;创建时间：</label>
                                <div class="col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="报警时间：">&nbsp;审核时间：</label>
                                <div class="col-xs-12">
                                    <div class="col-xs-12 col-sm-5">
            ...
            <!-- 工具栏 -->
            <div id="toolbar">
                <shiro:hasPermission name="report:exceptionReport:add">
                    <a id="add" class="btn btn-primary" href="${ctx}/cb/report/exceptionReport/form" title="异常上报"><i
                            class="glyphicon glyphicon-plus"></i> 新建</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="report:exceptionReport:edit">
                    <button id="edit" class="btn btn-success" disabled onclick="edit()">
                        <i class="glyphicon glyphicon-edit"></i> 编辑
                    </button>
                </shiro:hasPermission>
                <shiro:hasPermission name="report:exceptionReport:check">
                    <button id="check" class="btn btn-success" disabled onclick="check()">
                        <i class="glyphicon glyphicon-edit"></i> 审核
                    </button>
                </shiro:hasPermission>
                <shiro:hasPermission name="report:exceptionReport:del">
                ...
                <shiro:hasPermission name="report:exceptionReport:import">
                    ...
                    <div id="importBox" class="hide">
                        <form id="importForm" action="${ctx}/cb/report/exceptionReport/import" method="post"
            ...
            <!-- 表格 -->
            <table id="exceptionReportTable" data-toolbar="#toolbar"></table>

            <!-- context menu -->
            <ul id="context-menu" class="dropdown-menu">
                <shiro:hasPermission name="report:exceptionReport:check">
                    <li data-item="edit"><a>审核</a></li>
                </shiro:hasPermission>
                <shiro:hasPermission name="report:exceptionReport:del">
