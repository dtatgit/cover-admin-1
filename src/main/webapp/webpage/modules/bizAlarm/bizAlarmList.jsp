...
<head>
	...
	<%@include file="bizAlarmList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">业务报警列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="bizAlarm" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="报警编号：">报警编号：</label>
				<form:input path="alarmNo" htmlEscape="false" maxlength="128"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="井盖编号：">井盖编号：</label>
				<form:input path="coverNo" htmlEscape="false" maxlength="128"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="地址：">地址：</label>
				<form:input path="address" htmlEscape="false" maxlength="128"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="alarm:bizAlarm:add">
				<a id="add" class="btn btn-primary" href="${ctx}/cb/alarm/bizAlarm/form" title="业务报警"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="alarm:bizAlarm:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="alarm:bizAlarm:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
		<shiro:hasPermission name="alarm:bizAlarm:createWorks">
			<button id="createWorks" class="btn btn-danger" disabled onclick="createWorks()">
				<i class="glyphicon glyphicon-remove"></i> 生成工单
			</button>
		</shiro:hasPermission>
			<shiro:hasPermission name="alarm:bizAlarm:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/cb/alarm/bizAlarm/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="bizAlarmTable"   data-toolbar="#toolbar"></table>
    ...
    <ul id="context-menu" class="dropdown-menu">
		...
		<shiro:hasPermission name="alarm:bizAlarm:createWorks">
			<li data-item="createWorks"><a>生成工单</a></li>
		</shiro:hasPermission>
