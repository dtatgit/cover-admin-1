                        ...
                        <form:form id="searchForm" modelAttribute="flowProc" class="form form-horizontal well clearfix">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                ...
                                <form:select path="status" class="form-control m-b">
                                    <form:option value="" label=""/>
                                    <form:options items="${fns:getDictList('flow_proc_status')}" itemLabel="label"
                                                  itemValue="value" htmlEscape="false"/>
                                </form:select>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <div id="toolbar">
                ...
                <shiro:hasPermission name="flow:base:flowProc:import">
                    ...
                    <div id="importBox" class="hide">
                        <form id="importForm" action="${ctx}/flow/base/flowProc/import" method="post"
