...
<head>
	...
	<script type="text/javascript">
        ...
        //tab切换
        function Tabswitch(){
            $(".examinebox-box").find(".taskinfosx:first").show();
            $(".examinebox-tab span").on("click",function(){
                var index=$(this).index();
                $(".taskinfosx").hide().eq(index).show();
...
<body class="bg-white">
		...
		<%--		<div  class="accordion-body collapse">--%>
			...
			<div class="examinebox">
				<h1 class="title2">筛选任务内容</h1>
				<div class="examinebox-tab">
					<span class="active">条件筛选</span>
					<span>sql语句</span>
				</div>
			</div>
			<div class="examinebox-box">
