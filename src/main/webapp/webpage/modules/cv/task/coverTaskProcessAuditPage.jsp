        ...
        $(document).ready(function() {
            validateForm = $("#inputForm").validate({
                submitHandler: function(form){
                    jp.post("${ctx}/cv/equinfo/cover/repairSaveTask",$('#inputForm').serialize(),function(data){
                        if(data.success){
...
<body class="bg-white">
<form:form id="inputForm" modelAttribute="cover" action="${ctx}/cv/equinfo/cover/repairSaveTask" method="post" class="form-horizontal">
    <form:hidden path="id"/>
