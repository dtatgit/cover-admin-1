...
<head>
	...
	<%@include file="coverTaskInfoList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">井盖数据处理任务列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="coverTaskInfo" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="cv:task:coverTaskInfo:add">
			...
			<shiro:hasPermission name="cv:task:coverTaskInfo:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="cv:task:coverTaskInfo:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/cv/task/coverTaskInfo/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="coverTaskInfoTable"   data-toolbar="#toolbar"></table>
