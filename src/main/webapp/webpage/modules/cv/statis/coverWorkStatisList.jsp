...
<html>
<head>
	<title>工单完成统计管理</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@ include file="/webpage/include/treeview.jsp" %>
	<%@ include file="coverWorkStatisList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">工单完成统计列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="coverWorkStatisVo" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="操作人员：">操作人员：</label>
				<sys:userselect id="user" name="userId" value="${coverWorkStatisVo.userId}" labelName="userName" labelValue="${coverWorkStatisVo.userName}"
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="cv:statis:coverCollectStatis:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/cv/statis/coverCollectStatis/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="coverWorkStatisTable"   data-toolbar="#toolbar"></table>
