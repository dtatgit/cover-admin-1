...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-group">
			<div class="panel panel-primary">
				<div class="panel-heading" contenteditable="">普查信息</div>
									...
									<div class="row">
										<c:forEach items="${cover.coverImageList}" var="images">
											<div class="col-xs-6 col-sm-4 col-md-3">
												<a href="${images.url}" data-toggle="lightbox" data-group="image-group-1"><img src="${images.url}" class="img-rounded" alt="" width="200px"></a>
											</div>
										</c:forEach>
									</div>
			...
			<c:forEach var="item" items="${belllist}">
				...
				<c:choose>
								...
								<div>
									...
									<div class="col-xs-12 col-sm-4">
										<div class='input-group date'  >
											<input type='text'  id='startTime_${item.bellNo}' name="startTime" class="form-control startTime"  />
									...
									<div  class="col-xs-12 col-sm-4">
										<div class='input-group date'  >
											<input type='text'  id='endTime_${item.bellNo}' name="endTime" class="form-control endTime"  />
											<span class="input-group-addon">
                            					<span class="glyphicon glyphicon-calendar"></span>
                        					</span>
										</div>
									...
									<div>
										<a  id="search" class="btn btn-primary btn-rounded   btn-sm" onclick="searchT('${item.bellNo}');"><i class="fa fa-search"></i> 查询</a>
										<a  id="reset" class="btn btn-primary btn-rounded  btn-sm" onclick="clearText('${item.bellNo}');"><i class="fa fa-refresh"></i> 重置</a>
									</div>
					...
					<c:otherwise>
						<div class="panel panel-primary">
							<div class="panel-heading" contenteditable="">井卫IMEI:${item.imei}【未关联设备类型,默认显示】</div>
							<div class="panel-body">
