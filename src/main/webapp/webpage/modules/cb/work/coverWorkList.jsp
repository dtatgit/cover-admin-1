...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="coverWork" class="form form-horizontal well clearfix">
		...
		<shiro:hasPermission name="cb:work:coverWork:audit">
			...
			<shiro:hasPermission name="cb:work:coverWork:import">
				...
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/cb/work/coverWork/import" method="post" enctype="multipart/form-data"
