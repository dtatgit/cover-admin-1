...
<head>
	...
	<%@include file="coverWorkOperationList.js" %>
</head>
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="coverWorkOperation" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="工单信息：">工单信息：</label>
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:input path="operationStatus" htmlEscape="false" maxlength="64"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="操作用户：">操作用户：</label>
				<sys:userselect id="createBy" name="createBy.id" value="${coverWorkOperation.createBy.id}" labelName="createBy.name" labelValue="${coverWorkOperation.createBy.name}"
							    cssClass="form-control required"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
				 <div class="form-group">
					<label class="label-item single-overflow pull-left" title="操作时间：">&nbsp;操作时间：</label>
					<div class="col-xs-12">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="操作部门：">操作部门：</label>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="cb:work:coverWorkOperation:add">
			...
			<shiro:hasPermission name="cb:work:coverWorkOperation:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="cb:work:coverWorkOperation:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/cb/work/coverWorkOperation/import" method="post" enctype="multipart/form-data"
