...
public class TopicMessageListen {
    ...
    public TopicMessageListen(
        ...
        adapter.addListener(subscribeTopic, (t, m) -> {
            ...
            logger.info("[统一门户用户数据同步] : {}"+success+"操作类型："+operation+",同步内容："+data);
    ...
    public void created(UserPojo userPojo) {
        ...
        User userOld = systemService.getUserByLoginNameForAuth(userPojo.getUserNo(),CodeConstant.user_source.AUTH);
